...
const geoRoutes: Record<string, GeoRoute> = {
  'Mine A-Plant X': {
    ...
    junctions: [
      ...
      { name: 'Kalol Junction', coord: [23.2530, 72.4960], desc: 'Intermediate junction' },
      { name: 'Sabarmati Siding', coord: [23.0838, 72.5835], desc: 'Intermediate junction' },
      { name: 'Ahmedabad Junction', coord: [23.0269, 72.6012], desc: 'Junction stop: traffic clearance' },
      { name: 'Nadiad Junction', coord: [22.6860, 72.8680], desc: 'Intermediate junction' },
      { name: 'Anand Junction', coord: [22.5564, 72.9644], desc: 'Intermediate junction' },
      { name: 'Vadodara Junction', coord: [22.3106, 73.1812], desc: 'Intermediate point' },
      { name: 'Bharuch Junction', coord: [21.7088, 72.9934], desc: 'Intermediate junction' },
      { name: 'Surat Junction', coord: [21.2049, 72.8406], desc: 'Junction stop: crew change' },
      { name: 'Vyara Junction', coord: [21.1180, 73.3980], desc: 'Intermediate junction' },
      { name: 'Nandurbar Junction', coord: [21.7469, 74.1240], desc: 'Intermediate yard: speed control' },
      { name: 'Amalner Junction', coord: [21.0430, 75.0560], desc: 'Intermediate junction' },
      { name: 'Jalgaon Junction', coord: [21.0076, 75.5626], desc: 'Intermediate junction' },
      { name: 'Bhusaval Junction', coord: [21.0475, 75.7903], desc: 'Intermediate point' },
      { name: 'Akola Junction', coord: [20.7096, 77.0027], desc: 'Intermediate junction' },
      { name: 'Badnera Junction', coord: [20.8800, 77.7200], desc: 'Intermediate junction' },
      { name: 'Dhamangaon Jn', coord: [20.7800, 78.1300], desc: 'Intermediate junction' },
      { name: 'Wardha Junction', coord: [20.7408, 78.6022], desc: 'Intermediate yard: speed control' },
      { name: 'Hinganghat Jn', coord: [20.5600, 78.8400], desc: 'Intermediate junction' },
      { name: 'Warora Junction', coord: [20.2300, 79.0000], desc: 'Intermediate junction' },
      { name: 'Chandrapur Jn', coord: [19.9570, 79.2970], desc: 'Intermediate junction' },
      { name: 'Balharshah Junction', coord: [19.8524, 79.3512], desc: 'Junction stop: border checkpoint' },
      { name: 'Sirpur Kaghaznagar', coord: [19.3300, 79.4800], desc: 'Intermediate junction' },
      { name: 'Ramagundam Jn', coord: [18.8020, 79.4440], desc: 'Intermediate junction' },
      { name: 'Kazipet Junction', coord: [17.9780, 79.5200], desc: 'Intermediate junction' },
      { name: 'Warangal Junction', coord: [17.9689, 79.5941], desc: 'Intermediate point' },
      { name: 'Nalgonda Siding', coord: [17.0600, 79.2700], desc: 'Intermediate junction' },
      { name: 'Miryalaguda Jn', coord: [16.8700, 79.5600], desc: 'Intermediate junction' },
      { name: 'Guntur Junction', coord: [16.3060, 80.4360], desc: 'Intermediate junction' },
      { name: 'Vijayawada Junction', coord: [16.5062, 80.6480], desc: 'Junction stop: crew change' },
      { name: 'Tenali Junction', coord: [16.2400, 80.6400], desc: 'Intermediate junction' },
      { name: 'Bapatla Junction', coord: [15.9000, 80.4700], desc: 'Intermediate junction' },
      { name: 'Chirala Junction', coord: [15.8200, 80.3500], desc: 'Intermediate junction' },
      { name: 'Ongole Junction', coord: [15.5000, 80.0500], desc: 'Intermediate junction' },
      { name: 'Kavali Junction', coord: [14.9120, 79.9920], desc: 'Intermediate junction' },
      { name: 'Nellore Junction', coord: [14.4492, 79.9822], desc: 'Nellore junction siding switch' },
      { name: 'Venkatachalam Jn', coord: [14.3575, 79.9926], desc: 'Siding junction branch' },
      { name: 'SDSTPS Siding Curve', coord: [14.3458, 80.0460], desc: 'Siding curve entrance' },
      { name: 'SDSTPS Siding Entry', coord: [14.3420, 80.0750], desc: 'Siding approach track' },
      { name: 'SDSTPS Yard Approach', coord: [14.3351, 80.1065], desc: 'Siding terminal approach' },
      { name: 'Nellore SDSTPS Siding', coord: [14.3262, 80.1388], desc: 'Destination: South AP unloading yard' }
    ]
  },
