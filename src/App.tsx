...
const geoRoutes: Record<string, GeoRoute> = {
  'Mine A-Plant X': {
    ...
    junctions: [
      ...
      { name: 'Nalgonda Siding', coord: [17.0600, 79.2700], desc: 'Intermediate junction', isMain: false },
      { name: 'Miryalaguda Jn', coord: [16.8700, 79.5600], desc: 'Intermediate junction', isMain: false },
      { name: 'Guntur Junction', coord: [16.3060, 80.4360], desc: 'Intermediate junction', isMain: false },
