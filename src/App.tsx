...
const geoRoutes: Record<string, GeoRoute> = {
  'Mine A-Plant X': {
    ...
    junctions: [
      ...
      { name: 'Bhandu Motidau', coord: [23.5132, 72.4172], desc: 'Track alignment', isMain: false },
      { name: 'Jagudan Siding', coord: [23.4616, 72.4410], desc: 'Track alignment', isMain: false },
      { name: 'Dangarwa Junction', coord: [23.3645, 72.4720], desc: 'Track alignment', isMain: false },
      { name: 'Kalol Junction', coord: [23.2530, 72.4960], desc: 'Intermediate junction', isMain: false },
      { name: 'Khodiyar Siding', coord: [23.1818, 72.5367], desc: 'Track alignment', isMain: false },
      { name: 'Sabarmati Siding', coord: [23.0838, 72.5835], desc: 'Intermediate junction', isMain: false },
      { name: 'Ranip Crossing', coord: [23.0670, 72.5930], desc: 'Track alignment', isMain: false },
      { name: 'Ahmedabad Junction', coord: [23.0269, 72.6012], desc: 'Junction stop: traffic clearance', isMain: true },
      { name: 'Maninagar Siding', coord: [23.0031, 72.6145], desc: 'Track alignment', isMain: false },
      { name: 'Vatva Yard', coord: [22.9610, 72.6370], desc: 'Track alignment', isMain: false },
      { name: 'Barejadi Siding', coord: [22.8980, 72.6950], desc: 'Track alignment', isMain: false },
      { name: 'Mehmdavad Junction', coord: [22.8270, 72.7710], desc: 'Track alignment', isMain: false },
      { name: 'Nadiad Junction', coord: [22.6860, 72.8680], desc: 'Intermediate junction', isMain: false },
      { name: 'Kanjari Boriyavi', coord: [22.6090, 72.9230], desc: 'Track alignment', isMain: false },
      { name: 'Anand Junction', coord: [22.5564, 72.9644], desc: 'Intermediate junction', isMain: false },
      { name: 'Adas Road', coord: [22.4730, 73.0480], desc: 'Track alignment', isMain: false },
      { name: 'Vasad Junction', coord: [22.4430, 73.0680], desc: 'Track alignment', isMain: false },
      { name: 'Ranoli Siding', coord: [22.3850, 73.1360], desc: 'Track alignment', isMain: false },
      { name: 'Bajva Yard', coord: [22.3520, 73.1550], desc: 'Track alignment', isMain: false },
